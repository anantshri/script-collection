...
def main(argv):
    ...
    print("Base64 : " + base64.b64encode(input.encode()).decode("utf-8"))
    print("Base16 : " + base64.b16encode(input.encode()).decode("utf-8"))
    print("Base32 : " + base64.b32encode(input.encode()).decode("utf-8"))
